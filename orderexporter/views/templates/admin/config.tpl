...
<div class="bootstrap">
    ...
    <div>
        ...
        <div style="margin-top: 15px; border-top: 1px dotted #999;padding-top: 15px;">
            ...
            <p>
                <b>{l s='You have found a bug or a feature is missing?' mod='cdc_googletagmanager'}</b><br>
                <a href="https://addons.prestashop.com/contact-community.php?id_product=23806" target="_blank">{l s='Please contact us via Prestashop support' mod='cdc_googletagmanager'}</a>. {l s='Our team will answer in less than two business days.' mod='cdc_googletagmanager'}
            </p>
        </div>
